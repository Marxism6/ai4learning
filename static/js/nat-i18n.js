...
(function (N) {
  ...
  N.I18N = {
    zh: {
      ...
      memNewLabel:'AI 记忆系统', memModelLabel:'记忆提取模型', memModelPlaceholder:'deepseek-chat', memModelHint:'用于后台记忆提取的廉价模型，不影响主对话质量',
      searchHistory:'搜索历史对话...',
      blockStatus:'学习进度', uploadTitle:'上传题目截图',
      ...
      apiKeyLabel:'API Key', apiBaseLabel:'API 地址', modeLearn:'学习', modeSpeed:'速通', modeEye:'护眼', modeStd:'标准',
      memTitle:'跨会话记忆', langTitle:'切换语言', modeTitle:'切换颜色模式',
      studyModeLabel:'学习模式', langLabel:'语言', themeLabel:'主题', historyTitle:'历史对话（点击继续）',
    ...
    en: {
      ...
      memNewLabel:'AI Memory System', memModelLabel:'Memory extraction model', memModelPlaceholder:'deepseek-chat', memModelHint:'Cheap model for background memory extraction, does not affect main chat quality',
      searchHistory:'Search history...',
      blockStatus:'BLOCK STATUS', uploadTitle:'Upload problem screenshot',
      ...
      apiKeyLabel:'API Key', apiBaseLabel:'API Base URL', modeLearn:'Learn', modeSpeed:'Cram', modeEye:'Eye-care', modeStd:'Standard',
      memTitle:'Cross-session memory', langTitle:'Switch language', modeTitle:'Toggle color mode',
      studyModeLabel:'Study Mode', langLabel:'Language', themeLabel:'Theme', historyTitle:'History (click to resume)',
